...
class TrafficWeak(QMainWindow):
    def __init__(self):
        ...
        self.signFiles=[['ch6img/child.png','어린이'],['ch6img/elder.png','노인'],['ch6img/disabled.png','장애인']] #표지판 모델 영상
    ...
    def recognitionFunction(self):
        if self.roadImg is None:
            ...
            self.signImgs[best],     # 표지판 원본
            KD[best][0],             # 표지판 keypoints
            self.roadImg,            # 도로 영상
            road_kp,                 # 도로 keypoints
            GM[best],                # good matches
            None,
