...
(x_train,y_train),(x_test,y_test)=ds.mnist.load_data() # 해당 블록 = 데이터 준비
...
mlp=Sequential()
mlp.add(Dense(units=512,activation='tanh',input_shape=(784,))) #은닉층 노드 개수 512, 출력층 노드 개수 10, 
                                                               #은닉층 활성함수 tanh, 출력층 활성 함수 softmax
mlp.add(Dense(units=10,activation='softmax'))
#MSE 손실함수, SGD 옵티마이저, 학습률
